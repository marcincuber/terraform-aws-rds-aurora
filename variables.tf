variable "name" {
  type        = "string"
  description = "Name given to project"
}
...
variable "environment" {
  type        = "string"
  description = "Environment name; dev, uat, staging, prod etc."
}
...
variable "publicly_accessible" {
  type        = "string"
  default     = "false"
  description = "Assign public IP to your cluster"
}
...
variable "final_snapshot_identifier" {
  type        = "string"
  default     = "final"
  description = "The name to use when creating a final snapshot on cluster destroy, appends a random 8 digits to name to ensure it's unique."
}
...
variable "engine" {
  type        = "string"
  default     = "aurora"
  description = "Aurora database engine type; aurora, aurora-mysql or aurora-postgresql"
}
...
variable "family" { 
  type        = "string"
  default     = "aurora5.6"
  description = "Name of the family db parameter group for 5.7 use aurora-mysql5.7. Defaults to Aurora aurora5.6"
}
